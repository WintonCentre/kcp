...
var G__61101 = o;
reagent.impl.template.goog$module$goog$object.set(G__61101,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__61150__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__61150 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__61151__i = 0, G__61151__a = new Array(arguments.length -  0);
while (G__61151__i < G__61151__a.length) {G__61151__a[G__61151__i] = arguments[G__61151__i + 0]; ++G__61151__i;}
  args = new cljs.core.IndexedSeq(G__61151__a,0,null);
} 
return G__61150__delegate.call(this,args);};
G__61150.cljs$lang$maxFixedArity = 0;
G__61150.cljs$lang$applyTo = (function (arglist__61152){
var args = cljs.core.seq(arglist__61152);
return G__61150__delegate(args);
});
G__61150.cljs$core$IFn$_invoke$arity$variadic = G__61150__delegate;
return G__61150;
})()
;
} else {
...
var G__61107 = o;
reagent.impl.template.goog$module$goog$object.set(G__61107,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__61168__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__61168 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__61169__i < G__61169__a.length) {G__61169__a[G__61169__i] = arguments[G__61169__i + 0]; ++G__61169__i;}
  args = new cljs.core.IndexedSeq(G__61169__a,0,null);
} 
return G__61168__delegate.call(this,args);};
G__61168.cljs$lang$maxFixedArity = 0;
G__61168.cljs$lang$applyTo = (function (arglist__61170){
var args = cljs.core.seq(arglist__61170);
return G__61168__delegate(args);
});
...
var G__61116 = props;
var G__61116__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61116,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__61116);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61116__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__61128 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61128,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__61128;
}
})(),id_class);
...
var G__61135 = (cljs.core.count(argv) - first_child);
switch (G__61135) {
case (0):
...
var vec__61136 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61136,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61136,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61136,(2),null);
...
var temp__5757__auto___61190 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___61190 == null)){
} else {
var key_61191 = temp__5757__auto___61190;
(jsprops.key = key_61191);
}
...
var temp__5757__auto___61192 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___61192 == null)){
} else {
var key_61193 = temp__5757__auto___61192;
(jsprops.key = key_61193);
}
...
var temp__5757__auto___61195 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___61195 == null)){
} else {
var key_61196 = temp__5757__auto___61195;
(jsprops.key = key_61196);
}
...
var temp__5757__auto___61226 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___61226 == null)){
} else {
var key_61227 = temp__5757__auto___61226;
(jsprops.key = key_61227);
}
...
var temp__5757__auto___61228 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___61228 == null)){
} else {
var key_61229 = temp__5757__auto___61228;
(jsprops.key = key_61229);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61139_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__61139_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__61140 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61140,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61140,(1),null);
...
break;
default:
var G__61231 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__61232 = compiler;
v = G__61231;
compiler = G__61232;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template61147 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template61147 = (function (opts,id,fn_to_element,parse_fn,meta61148){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template61147.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61149,meta61148__$1){
var self__ = this;
var _61149__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template61147(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta61148__$1));
}));

(reagent.impl.template.t_reagent$impl$template61147.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61149){
var self__ = this;
var _61149__$1 = this;
return self__.meta61148;
}));

(reagent.impl.template.t_reagent$impl$template61147.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template61147.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template61147.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template61147.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template61147.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template61147.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta61148","meta61148",-868761208,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template61147.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template61147.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template61147");

(reagent.impl.template.t_reagent$impl$template61147.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template61147");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template61147.
 */
reagent.impl.template.__GT_t_reagent$impl$template61147 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template61147(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta61148){
return (new reagent.impl.template.t_reagent$impl$template61147(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta61148));
});

}

return (new reagent.impl.template.t_reagent$impl$template61147(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
