...
if((x instanceof cljs.core.Keyword)){
var G__65730 = spec;
var G__65731 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__65730,G__65731) : f.call(null,G__65730,G__65731));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__65732 = spec;
var G__65733 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__65732,G__65733) : f.call(null,G__65732,G__65733));
} else {
return x;
...
}catch (e65734){if((e65734 instanceof Error)){
var ___$1 = e65734;
return x;
} else {
throw e65734;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__65740,x){
var map__65741 = p__65740;
var map__65741__$1 = cljs.core.__destructure_map(map__65741);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65741__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__65742,x){
var map__65743 = p__65742;
var map__65743__$1 = cljs.core.__destructure_map(map__65743);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65743__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__65745,x){
var map__65746 = p__65745;
var map__65746__$1 = cljs.core.__destructure_map(map__65746);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65746__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
