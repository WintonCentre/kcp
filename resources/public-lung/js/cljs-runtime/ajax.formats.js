...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__81359){
var map__81360 = p__81359;
var map__81360__$1 = cljs.core.__destructure_map(map__81360);
var request = map__81360__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81360__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__81364 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__81364.cljs$core$IFn$_invoke$arity$1 ? fexpr__81364.cljs$core$IFn$_invoke$arity$1(response) : fexpr__81364.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__81365 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__81365.cljs$core$IFn$_invoke$arity$1 ? fexpr__81365.cljs$core$IFn$_invoke$arity$1(response) : fexpr__81365.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__81366){
var map__81367 = p__81366;
var map__81367__$1 = cljs.core.__destructure_map(map__81367);
var request = map__81367__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81367__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
