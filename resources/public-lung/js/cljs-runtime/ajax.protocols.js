...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_81149 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_81149(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_81150 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_81150(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_81151 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_81151(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_81152 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_81152(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_81153 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_81153(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_81155 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_81155(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_81157 = (function (this$,header){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_81157(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_81158 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_81158(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_81159 = (function (this$,request){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_81159(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_81160 = (function (this$,response){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_81160(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k81120,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k81120,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__81127){
var vec__81128 = p__81127;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81128,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81128,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this81121,other81122){
var self__ = this;
var this81121__$1 = this;
return (((!((other81122 == null)))) && ((((this81121__$1.constructor === other81122.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this81121__$1.status,other81122.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this81121__$1.body,other81122.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this81121__$1.status_text,other81122.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this81121__$1.headers,other81122.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this81121__$1.was_aborted,other81122.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this81121__$1.__extmap,other81122.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k81120){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k81120);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__81119){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__81139 = cljs.core.keyword_identical_QMARK_;
var expr__81140 = k__4511__auto__;
if(cljs.core.truth_((pred__81139.cljs$core$IFn$_invoke$arity$2 ? pred__81139.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__81140) : pred__81139.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__81140)))){
return (new ajax.protocols.Response(G__81119,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__81139.cljs$core$IFn$_invoke$arity$2 ? pred__81139.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__81140) : pred__81139.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__81140)))){
return (new ajax.protocols.Response(self__.status,G__81119,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__81139.cljs$core$IFn$_invoke$arity$2 ? pred__81139.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__81140) : pred__81139.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__81140)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__81119,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__81139.cljs$core$IFn$_invoke$arity$2 ? pred__81139.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__81140) : pred__81139.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__81140)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__81119,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__81139.cljs$core$IFn$_invoke$arity$2 ? pred__81139.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__81140) : pred__81139.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__81140)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__81119,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__81119),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__81119){
var self__ = this;
var this__4501__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__81119,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__81123){
var extmap__4542__auto__ = (function (){var G__81146 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__81123,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__81123)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__81146);
} else {
return G__81146;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__81123),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__81123),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__81123),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__81123),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__81123),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
