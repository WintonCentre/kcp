      ...
      [ui/page (str " Legal ")
       [ui/row
        [:> bs/Col
         ...
         [:p "This website uses Matomo to analyze traffic and help us to improve your user experience. The default data listed " [:a {:href "https://fr.matomo.org/faq/general/faq_18254/"} " here "] "is anonymized as part of their processing."]
