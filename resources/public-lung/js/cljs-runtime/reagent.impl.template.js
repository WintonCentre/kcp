...
var G__77542 = o;
reagent.impl.template.goog$module$goog$object.set(G__77542,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__77560__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__77560 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__77561__i = 0, G__77561__a = new Array(arguments.length -  0);
while (G__77561__i < G__77561__a.length) {G__77561__a[G__77561__i] = arguments[G__77561__i + 0]; ++G__77561__i;}
  args = new cljs.core.IndexedSeq(G__77561__a,0,null);
} 
return G__77560__delegate.call(this,args);};
G__77560.cljs$lang$maxFixedArity = 0;
G__77560.cljs$lang$applyTo = (function (arglist__77562){
var args = cljs.core.seq(arglist__77562);
return G__77560__delegate(args);
});
G__77560.cljs$core$IFn$_invoke$arity$variadic = G__77560__delegate;
return G__77560;
})()
;
} else {
...
var G__77543 = o;
reagent.impl.template.goog$module$goog$object.set(G__77543,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__77563__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__77563 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__77564__i = 0, G__77564__a = new Array(arguments.length -  0);
while (G__77564__i < G__77564__a.length) {G__77564__a[G__77564__i] = arguments[G__77564__i + 0]; ++G__77564__i;}
  args = new cljs.core.IndexedSeq(G__77564__a,0,null);
} 
return G__77563__delegate.call(this,args);};
G__77563.cljs$lang$maxFixedArity = 0;
G__77563.cljs$lang$applyTo = (function (arglist__77565){
var args = cljs.core.seq(arglist__77565);
return G__77563__delegate(args);
});
G__77563.cljs$core$IFn$_invoke$arity$variadic = G__77563__delegate;
return G__77563;
})()
;
} else {
...
var G__77544 = props;
var G__77544__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__77544,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__77544);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__77544__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__77545 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__77545,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__77545;
}
})(),id_class);
...
var G__77546 = (cljs.core.count(argv) - first_child);
switch (G__77546) {
case (0):
...
var vec__77547 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77547,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77547,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77547,(2),null);
...
var temp__5757__auto___77573 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___77573 == null)){
} else {
var key_77574 = temp__5757__auto___77573;
(jsprops.key = key_77574);
}
...
var temp__5757__auto___77575 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___77575 == null)){
} else {
var key_77576 = temp__5757__auto___77575;
(jsprops.key = key_77576);
}
...
var temp__5757__auto___77577 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___77577 == null)){
} else {
var key_77578 = temp__5757__auto___77577;
(jsprops.key = key_77578);
}
...
var temp__5757__auto___77582 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___77582 == null)){
} else {
var key_77584 = temp__5757__auto___77582;
(jsprops.key = key_77584);
}
...
var temp__5757__auto___77585 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___77585 == null)){
} else {
var key_77586 = temp__5757__auto___77585;
(jsprops.key = key_77586);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__77550_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__77550_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__77551 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77551,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77551,(1),null);
...
break;
default:
var G__77589 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__77590 = compiler;
v = G__77589;
compiler = G__77590;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template77557 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template77557 = (function (opts,id,fn_to_element,parse_fn,meta77558){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta77558 = meta77558;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template77557.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_77559,meta77558__$1){
var self__ = this;
var _77559__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template77557(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta77558__$1));
}));

(reagent.impl.template.t_reagent$impl$template77557.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_77559){
var self__ = this;
var _77559__$1 = this;
return self__.meta77558;
}));

(reagent.impl.template.t_reagent$impl$template77557.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template77557.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template77557.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template77557.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template77557.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template77557.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta77558","meta77558",-1672115116,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template77557.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template77557.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template77557");

(reagent.impl.template.t_reagent$impl$template77557.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template77557");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template77557.
 */
reagent.impl.template.__GT_t_reagent$impl$template77557 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template77557(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta77558){
return (new reagent.impl.template.t_reagent$impl$template77557(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta77558));
});

}

return (new reagent.impl.template.t_reagent$impl$template77557(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
