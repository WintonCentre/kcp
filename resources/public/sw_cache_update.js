...
function precache() {
    ...
    return caches.open(LATEST_CACHE_ID).then(function(cache) {
        return cache.addAll([
            ...
            '/manifest.json',
            // '/assets/lung/birm.jpg',
            // '/assets/lung/birm.png',
            // '/assets/lung/hare.jpg',
            // '/assets/lung/hare.png',
            // '/assets/lung/man.jpg',
            // '/assets/lung/man.png',
            // '/assets/lung/new.jpg',
            // '/assets/lung/new.png',
            '/assets/kidney/barts.png',
            '/assets/kidney/bel.png',
            '/assets/kidney/birm.png',
            '/assets/kidney/bris.png',
            '/assets/kidney/cam.png',
            '/assets/kidney/card.png',
            '/assets/kidney/cov.png',
            '/assets/kidney/edin.png',
            '/assets/kidney/glas.png',
            '/assets/kidney/guys.png',
            '/assets/kidney/leeds.png',
            '/assets/kidney/leic.png',
            '/assets/kidney/liv.png',
            '/assets/kidney/man.png',
            '/assets/kidney/new.png',
            '/assets/kidney/nott.png',
            '/assets/kidney/notts.png',
            '/assets/kidney/osm_logo.svg',
            '/assets/kidney/oxon.png',
            '/assets/kidney/plym.png',
            '/assets/kidney/port.png',
            '/assets/kidney/royalfree.png',
            '/assets/kidney/shef.png',
            '/assets/kidney/sheff.png',
            '/assets/kidney/stgs.png',
            '/assets/kidney/wlrtc.png',
            '/assets/logo_kidney_192.png',
            '/assets/logo_kidney_512.png',
            '/assets/crest.png',
            '/assets/kidney-banner.png',
            // '/assets/lung-banner.png',
            '/assets/nhsbt-left-align_scaled.svg',
            '/assets/Post Transplant Medications.png',
