...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__67417){
var map__67418 = p__67417;
var map__67418__$1 = cljs.core.__destructure_map(map__67418);
var request = map__67418__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67418__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__67423 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__67423.cljs$core$IFn$_invoke$arity$1 ? fexpr__67423.cljs$core$IFn$_invoke$arity$1(response) : fexpr__67423.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__67424 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__67424.cljs$core$IFn$_invoke$arity$1 ? fexpr__67424.cljs$core$IFn$_invoke$arity$1(response) : fexpr__67424.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__67425){
var map__67426 = p__67425;
var map__67426__$1 = cljs.core.__destructure_map(map__67426);
var request = map__67426__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67426__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
