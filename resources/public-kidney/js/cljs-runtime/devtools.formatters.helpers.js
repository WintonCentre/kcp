...
var G__50189 = devtools.prefs.pref(v);
v = G__50189;
continue;
} else {
return v;
...
}catch (e50159){var _e__36376__auto__ = e50159;
return false;
}})();
...
}catch (e50162){var _e__36376__auto__ = e50162;
return false;
}})();
...
}catch (e50164){var _e__36376__auto__ = e50164;
return false;
}}
}
});
...
var vec__50175 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50175,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50175,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__50183_SHARP_);
}),template);
});
