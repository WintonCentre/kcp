...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(W1S0,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.last,cljs.core.partition_by.cljs$core$IFn$_invoke$arity$2((function (p__81493){
var vec__81494 = p__81493;
var day = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81494,(0),null);
var _H = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81494,(1),null);
return transplants.utils.day__GT_week(day);
}),M1S0)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.last,cljs.core.partition_by.cljs$core$IFn$_invoke$arity$2((function (p__81499){
var vec__81500 = p__81499;
var day = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81500,(0),null);
var _H = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81500,(1),null);
return transplants.utils.day__GT_month(day);
}),Q1S0)),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.last,cljs.core.partition_by.cljs$core$IFn$_invoke$arity$2((function (p__81503){
var vec__81504 = p__81503;
var day = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81504,(0),null);
var _H = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81504,(1),null);
...
while(true){
var vec__81519 = cljs.core.first(SD);
var _days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81519,(0),null);
var S = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81519,(1),null);
var SD_PLUS_ = cljs.core.rest(SD);
if(cljs.core.seq(SD_PLUS_)){
var vec__81522 = cljs.core.first(SD_PLUS_);
var days_PLUS_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81522,(0),null);
var S_PLUS_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81522,(1),null);
var H = cljs.core.map.cljs$core$IFn$_invoke$arity$3(cljs.core._STAR_,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (SD,s,f,_sumall,result,vec__81522,days_PLUS_,S_PLUS_,vec__81519,_days,S,SD_PLUS_,exp_sum_beta_xs){
return (function (p1__81507_SHARP_){
return (- Math.log(p1__81507_SHARP_));
});})(SD,s,f,_sumall,result,vec__81522,days_PLUS_,S_PLUS_,vec__81519,_days,S,SD_PLUS_,exp_sum_beta_xs))
,S),exp_sum_beta_xs);
var H_PLUS_ = cljs.core.map.cljs$core$IFn$_invoke$arity$3(cljs.core._STAR_,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (SD,s,f,_sumall,result,vec__81522,days_PLUS_,S_PLUS_,H,vec__81519,_days,S,SD_PLUS_,exp_sum_beta_xs){
return (function (p1__81508_SHARP_){
return (- Math.log(p1__81508_SHARP_));
});})(SD,s,f,_sumall,result,vec__81522,days_PLUS_,S_PLUS_,H,vec__81519,_days,S,SD_PLUS_,exp_sum_beta_xs))
,S_PLUS_),exp_sum_beta_xs);
var delta_h = cljs.core.map.cljs$core$IFn$_invoke$arity$3(cljs.core._,H_PLUS_,H);
var p = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (SD,s,f,_sumall,result,vec__81522,days_PLUS_,S_PLUS_,H,H_PLUS_,delta_h,vec__81519,_days,S,SD_PLUS_,exp_sum_beta_xs){
return (function (p1__81509_SHARP_){
return (s * p1__81509_SHARP_);
});})(SD,s,f,_sumall,result,vec__81522,days_PLUS_,S_PLUS_,H,H_PLUS_,delta_h,vec__81519,_days,S,SD_PLUS_,exp_sum_beta_xs))
,delta_h);
...
var G__81570 = SD_PLUS_;
var G__81571 = s_PLUS_;
var G__81572 = f_PLUS_;
var G__81573 = sumall_PLUS_;
var G__81574 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [days_PLUS_,f_PLUS_], null));
SD = G__81570;
s = G__81571;
f = G__81572;
_sumall = G__81573;
...
var rv = cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__81535_SHARP_){
return (cljs.core.first(p1__81535_SHARP_) <= day);
}),S0));
...
if(cljs.core.seq(ss)){
var vec__81540 = cljs.core.split_with(((function (ds,ss,result,d,temp__5751__auto__){
return (function (p1__81536_SHARP_){
return (cljs.core.first(p1__81536_SHARP_) <= d);
});})(ds,ss,result,d,temp__5751__auto__))
,ss);
var accept = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81540,(0),null);
var reject = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81540,(1),null);
var G__81576 = cljs.core.rest(ds);
var G__81577 = reject;
var G__81578 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,((cljs.core.seq(accept))?cljs.core.last(accept):cljs.core.last(result)));
ds = G__81576;
ss = G__81577;
result = G__81578;
continue;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__81548_SHARP_){
return ((1) - Math.pow(s0_for_day,Math.exp(p1__81548_SHARP_)));
}),sum_x_betas);
});
