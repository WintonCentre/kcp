...
We're relaxing the constraint of making the reagent components themselves unit-testable as that is simply
too much work for too little benefit. Instead, test using devcards or etaoin."
...
In all cases the bsio compononent simply calls value-f to get the needed value.
