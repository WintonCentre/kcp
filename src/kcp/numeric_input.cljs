...
(comment
  ; todo jack: convert into test cases
  (js/isNaN 4.1)
  (and 1 (>= 1 1))
  (near-integer? 4.4)
  (to-dps 4.4 0)
  ...
  ; todo jack: add test case for nil
  (num-to-str 4.4 0)
  (num-to-str 4.4 1)
  (num-to-str 4.4 2))
...
(comment
  ; todo jack: make these test cases, add one for nil
  ; todo jack: test case for clamping on increment / decrement
...
(comment
  ; todo jack: test cases from this?
