...
var G__71774 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__71774;
continue;
} else {
return ch;
...
var vec__71769 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71769,(0),null);
return (match === s);
});
...
var len__4864__auto___71775 = arguments.length;
var i__4865__auto___71776 = (0);
while(true){
if((i__4865__auto___71776 < len__4864__auto___71775)){
args__4870__auto__.push((arguments[i__4865__auto___71776]));

var G__71777 = (i__4865__auto___71776 + (1));
i__4865__auto___71776 = G__71777;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq71772){
var G__71773 = cljs.core.first(seq71772);
var seq71772__$1 = cljs.core.next(seq71772);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__71773,seq71772__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__71778__delegate = function (rdr,_){
...
var G__71778 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__71779__i = 0, G__71779__a = new Array(arguments.length -  1);
while (G__71779__i < G__71779__a.length) {G__71779__a[G__71779__i] = arguments[G__71779__i + 1]; ++G__71779__i;}
  _ = new cljs.core.IndexedSeq(G__71779__a,0,null);
} 
return G__71778__delegate.call(this,rdr,_);};
G__71778.cljs$lang$maxFixedArity = 1;
G__71778.cljs$lang$applyTo = (function (arglist__71780){
var rdr = cljs.core.first(arglist__71780);
var _ = cljs.core.rest(arglist__71780);
return G__71778__delegate(rdr,_);
});
