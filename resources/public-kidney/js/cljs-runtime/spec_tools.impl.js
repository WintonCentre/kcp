...
var vec__65496 = cljs.core.rest(expr);
var seq__65497 = cljs.core.seq(vec__65496);
var first__65498 = cljs.core.first(seq__65497);
var seq__65497__$1 = cljs.core.next(seq__65497);
var vec__65499 = first__65498;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65499,(0),null);
var form = seq__65497__$1;
...
var G__65506 = x;
var G__65506__$1 = (((G__65506 == null))?null:spec_tools.impl.polish(G__65506));
var G__65506__$2 = (((G__65506__$1 == null))?null:cljs.core.name(G__65506__$1));
if((G__65506__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__65506__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__65507 = x;
var G__65507__$1 = (((G__65507 == null))?null:cljs.core.name(G__65507));
if((G__65507__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__65507__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__65508){
var map__65509 = p__65508;
var map__65509__$1 = cljs.core.__destructure_map(map__65509);
var data = map__65509__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65509__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65509__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65509__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65509__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__65511){
var map__65512 = p__65511;
var map__65512__$1 = cljs.core.__destructure_map(map__65512);
var data = map__65512__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65512__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65512__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__65515 = data;
var G__65515__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__65515,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__65515);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__65515__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__65515__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__65528 = form;
var G__65528__$1 = (((G__65528 == null))?null:cljs.core.rest(G__65528));
if((G__65528__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__65528__$1);
}
})();
var G__65532 = m;
var G__65532__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__65532,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__65517_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__65517_SHARP_)));
})):G__65532);
var G__65532__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__65532__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__65520_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__65520_SHARP_)));
})):G__65532__$1);
var G__65532__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__65532__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__65523_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__65523_SHARP_));
})):G__65532__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__65532__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__65537 = (function (){var G__65538 = form;
var G__65538__$1 = (((G__65538 == null))?null:cljs.core.rest(G__65538));
if((G__65538__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__65538__$1);
}
})();
var map__65537__$1 = cljs.core.__destructure_map(map__65537);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65537__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65537__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65537__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65537__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__65552 = (function (){var and__4251__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__65578 = form;
var G__65578__$1 = (((G__65578 == null))?null:cljs.core.seq(G__65578));
var G__65578__$2 = (((G__65578__$1 == null))?null:cljs.core.first(G__65578__$1));
if((G__65578__$2 == null)){
return null;
} else {
var fexpr__65579 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__65579.cljs$core$IFn$_invoke$arity$1 ? fexpr__65579.cljs$core$IFn$_invoke$arity$1(G__65578__$2) : fexpr__65579.call(null,G__65578__$2));
}
})():null));
});
/**
...
var G__65678 = (i__4865__auto___65677 + (1));
i__4865__auto___65677 = G__65678;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq65580){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq65580));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__65593){
var vec__65594 = p__65593;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65594,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65594,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__65618){
var map__65619 = p__65618;
var map__65619__$1 = cljs.core.__destructure_map(map__65619);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65619__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65619__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65619__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65619__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__65616_SHARP_){
return cljs.core.map_QMARK_(p1__65616_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__65617_SHARP_){
return cljs.core.contains_QMARK_(p1__65617_SHARP_,x);
});
}),req_keys));
