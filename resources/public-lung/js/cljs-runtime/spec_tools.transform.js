...
if((x instanceof cljs.core.Keyword)){
var G__80136 = spec;
var G__80137 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__80136,G__80137) : f.call(null,G__80136,G__80137));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__80138 = spec;
var G__80139 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__80138,G__80139) : f.call(null,G__80138,G__80139));
} else {
return x;
...
}catch (e80140){if((e80140 instanceof Error)){
var ___$1 = e80140;
return x;
} else {
throw e80140;
...
}catch (e80141){if((e80141 instanceof Error)){
var ___$1 = e80141;
return x;
} else {
throw e80141;
...
}catch (e80142){if((e80142 instanceof Error)){
var ___$1 = e80142;
return x;
} else {
throw e80142;
...
}catch (e80143){if((e80143 instanceof Error)){
var ___$1 = e80143;
return x;
} else {
throw e80143;
...
}catch (e80144){if((e80144 instanceof Error)){
var ___$1 = e80144;
return x;
} else {
throw e80144;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__80145,x){
var map__80146 = p__80145;
var map__80146__$1 = cljs.core.__destructure_map(map__80146);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80146__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__80147,x){
var map__80148 = p__80147;
var map__80148__$1 = cljs.core.__destructure_map(map__80148);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80148__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__80149,x){
var map__80150 = p__80149;
var map__80150__$1 = cljs.core.__destructure_map(map__80150);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80150__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
