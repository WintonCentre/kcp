...
f(b = 3, a = 4)
```
Now create a string representation of f from f
```{r}
deparse(f)
```
...
* All the zero effect levels
* With the first non-zero effect level, keeping all other levels at zero effect



```{r}
r <- adjcox(cent = "Belfast", rage = 3, wait = 1, diabetes = 1, graft = 1, dage = 4, dbmi = 1, dhtn = 2, hla = 1) %>%
as.data.frame()
