 ...
 */
transplants.bsio.radio_button_group = (function transplants$bsio$radio_button_group(p__67832){
var map__67834 = p__67832;
var map__67834__$1 = cljs.core.__destructure_map(map__67834);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67834__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var value_f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67834__$1,new cljs.core.Keyword(null,"value-f","value-f",-1842795108));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67834__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var buttons_f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67834__$1,new cljs.core.Keyword(null,"buttons-f","buttons-f",120679154));
var _vertical = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67834__$1,new cljs.core.Keyword(null,"_vertical","_vertical",-1198358645));
var _optional = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67834__$1,new cljs.core.Keyword(null,"_optional","_optional",2085316983));
...
transplants.bsio.dropdown = (function transplants$bsio$dropdown(p__67856){
var map__67858 = p__67856;
var map__67858__$1 = cljs.core.__destructure_map(map__67858);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67858__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var value_f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67858__$1,new cljs.core.Keyword(null,"value-f","value-f",-1842795108));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67858__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var buttons_f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67858__$1,new cljs.core.Keyword(null,"buttons-f","buttons-f",120679154));
var value = (value_f.cljs$core$IFn$_invoke$arity$0 ? value_f.cljs$core$IFn$_invoke$arity$0() : value_f.call(null));
var buttons = (buttons_f.cljs$core$IFn$_invoke$arity$0 ? buttons_f.cljs$core$IFn$_invoke$arity$0() : buttons_f.call(null));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$react_bootstrap$cjs$index.Dropdown,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-select","on-select",-192407950),(function (p1__67850_SHARP_){
var G__67863 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(p1__67850_SHARP_);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__67863) : on_change.call(null,G__67863));
})], null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$react_bootstrap$cjs$index.DropdownButton,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"value","value",305978217),value,new cljs.core.Keyword(null,"variant","variant",-424354234),(((value == null))?"outline-secondary":"secondary"),new cljs.core.Keyword(null,"title","title",636505583),new cljs.core.Keyword(null,"level-name","level-name",-1650644216).cljs$core$IFn$_invoke$arity$1(cljs.core.first((function (){var temp__5751__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__67871){
var map__67872 = p__67871;
var map__67872__$1 = cljs.core.__destructure_map(map__67872);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67872__$1,new cljs.core.Keyword(null,"level","level",1290497552));
...
var map__67913 = cljs.core.deref((data_f.cljs$core$IFn$_invoke$arity$0 ? data_f.cljs$core$IFn$_invoke$arity$0() : data_f.call(null)));
var map__67913__$1 = cljs.core.__destructure_map(map__67913);
var data = map__67913__$1;
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67913__$1,new cljs.core.Keyword(null,"title","title",636505583));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67913__$1,new cljs.core.Keyword(null,"content","content",15833224));
var cancel = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67913__$1,new cljs.core.Keyword(null,"cancel","cancel",-1964088360));
var save = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67913__$1,new cljs.core.Keyword(null,"save","save",1850079149));
var ok = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67913__$1,new cljs.core.Keyword(null,"ok","ok",967785236));
