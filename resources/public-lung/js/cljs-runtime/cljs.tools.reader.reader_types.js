...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_71720 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_71720(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_71721 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_71721(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_71722 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_71722(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_71723 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_71723(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_71724 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_71724(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_71728 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_71728(reader);
}
});
...
var G__71740 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__71741 = s.append(c);
c = G__71740;
s = G__71741;
continue;
}
