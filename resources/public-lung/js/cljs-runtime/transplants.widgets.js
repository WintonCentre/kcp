...
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword(null,"unsupported","unsupported",-1045607016)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__81924 = cljs.core.get_global_hierarchy;
return (fexpr__81924.cljs$core$IFn$_invoke$arity$0 ? fexpr__81924.cljs$core$IFn$_invoke$arity$0() : fexpr__81924.call(null));
})());
...
transplants.widgets.radio = (function transplants$widgets$radio(p__81927){
var map__81928 = p__81927;
var map__81928__$1 = cljs.core.__destructure_map(map__81928);
var w = map__81928__$1;
var factor_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81928__$1,new cljs.core.Keyword(null,"factor-name","factor-name",-1453446694));
var _default = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81928__$1,new cljs.core.Keyword(null,"_default","_default",308892991));
var _boxed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81928__$1,new cljs.core.Keyword(null,"_boxed","_boxed",1447315520));
var info_box_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81928__$1,new cljs.core.Keyword(null,"info-box?","info-box?",825044934));
var _type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81928__$1,new cljs.core.Keyword(null,"_type","_type",-970742198));
var vertical = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81928__$1,new cljs.core.Keyword(null,"vertical","vertical",718696748));
var levels = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81928__$1,new cljs.core.Keyword(null,"levels","levels",-950747887));
var optional = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81928__$1,new cljs.core.Keyword(null,"optional","optional",2053951509));
var factor_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81928__$1,new cljs.core.Keyword(null,"factor-key","factor-key",-1402681225));
...
transplants.widgets.widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"dropdown","dropdown",1343185805),(function (p__81931){
var map__81932 = p__81931;
var map__81932__$1 = cljs.core.__destructure_map(map__81932);
var w = map__81932__$1;
var _factor_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81932__$1,new cljs.core.Keyword(null,"_factor-name","_factor-name",-8697381));
var factor_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81932__$1,new cljs.core.Keyword(null,"factor-key","factor-key",-1402681225));
var levels = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81932__$1,new cljs.core.Keyword(null,"levels","levels",-950747887));
var _default = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81932__$1,new cljs.core.Keyword(null,"_default","_default",308892991));
var _type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81932__$1,new cljs.core.Keyword(null,"_type","_type",-970742198));
var value_f = (function (){
return cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [factor_key], null)));
});
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$react_bootstrap$cjs$index.Row,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"align-items","align-items",-267946462),"center",new cljs.core.Keyword(null,"margin-bottom","margin-bottom",388334941),transplants.widgets.mb], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$react_bootstrap$cjs$index.Col,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"xs","xs",649443341),transplants.widgets.label_width,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"justify-content","justify-content",-1990475787),"flex-end"], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$react_bootstrap$cjs$index.Form.Label,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),"bold",new cljs.core.Keyword(null,"text-align","text-align",1786091845),"right",new cljs.core.Keyword(null,"line-height","line-height",1870784992),1.2], null)], null),new cljs.core.Keyword(null,"factor-name","factor-name",-1453446694).cljs$core$IFn$_invoke$arity$1(w)], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$react_bootstrap$cjs$index.Col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"xs","xs",649443341),transplants.widgets.widget_width], null),transplants.bsio.dropdown(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),transplants.widgets.key__GT_id(factor_key),new cljs.core.Keyword(null,"value-f","value-f",-1842795108),value_f,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__81930_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [factor_key,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(p1__81930_SHARP_)], null));
}),new cljs.core.Keyword(null,"buttons-f","buttons-f",120679154),(function (){
return cljs.core.vals(levels);
})], null))], null)], null);
}));
transplants.widgets.widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"numeric","numeric",-1495594714),(function (p__81934){
var map__81935 = p__81934;
var map__81935__$1 = cljs.core.__destructure_map(map__81935);
var w = map__81935__$1;
var _factor_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81935__$1,new cljs.core.Keyword(null,"_factor-name","_factor-name",-8697381));
var factor_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81935__$1,new cljs.core.Keyword(null,"factor-key","factor-key",-1402681225));
var _factor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81935__$1,new cljs.core.Keyword(null,"_factor","_factor",233356458));
var _levels = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81935__$1,new cljs.core.Keyword(null,"_levels","_levels",696902097));
var _default = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81935__$1,new cljs.core.Keyword(null,"_default","_default",308892991));
var _type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81935__$1,new cljs.core.Keyword(null,"_type","_type",-970742198));
var _model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81935__$1,new cljs.core.Keyword(null,"_model","_model",-698954695));
var value_f = (function (){
return cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [factor_key], null)));
});
...
transplants.widgets.widget.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"unsupported","unsupported",-1045607016),(function (p__81937){
var map__81938 = p__81937;
var map__81938__$1 = cljs.core.__destructure_map(map__81938);
var m = map__81938__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81938__$1,new cljs.core.Keyword(null,"type","type",1174270348));
