...
var fexpr__80088 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__80088.cljs$core$IFn$_invoke$arity$1 ? fexpr__80088.cljs$core$IFn$_invoke$arity$1(type) : fexpr__80088.call(null,type));
});
...
var G__80132 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__80132;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__80094 = spec_tools.impl.normalize_symbol(x);
var G__80095 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__80094,G__80095) : spec_tools.parse.parse_form.call(null,G__80094,G__80095));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__80096 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__80097 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__80096,G__80097) : spec_tools.parse.parse_form.call(null,G__80096,G__80097));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__80135 = cljs.spec.alpha.form(x);
x = G__80135;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__80098 = spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x);
var G__80099 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__80098,G__80099) : spec_tools.parse.parse_form.call(null,G__80098,G__80099));
} else {
...
var G__80104 = parse_data;
var G__80104__$1 = (((G__80104 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__80104));
var G__80104__$2 = (((G__80104__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__80104__$1));
var G__80104__$3 = (((G__80104__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__80104__$2));
var G__80104__$4 = (((G__80104__$3 == null))?null:cljs.core.seq(G__80104__$3));
if((G__80104__$4 == null)){
return null;
} else {
return cljs.core.set(G__80104__$4);
}
}
});
...
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__80105 = cljs.core.get_global_hierarchy;
return (fexpr__80105.cljs$core$IFn$_invoke$arity$0 ? fexpr__80105.cljs$core$IFn$_invoke$arity$0() : fexpr__80105.call(null));
})());
...
var map__80114 = spec_tools.impl.parse_keys(form);
var map__80114__$1 = cljs.core.__destructure_map(map__80114);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80114__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80114__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80114__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80114__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80114__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__80115 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__80115__$1 = (cljs.core.truth_((function (){var or__4253__auto__ = req;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__80115,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__80115);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__80115__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__80115__$1;
}
}));
...
var map__80118 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__80118__$1 = cljs.core.__destructure_map(map__80118);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80118__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__80119 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__80119__$1 = cljs.core.__destructure_map(map__80119);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80119__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__80124){
var vec__80125 = p__80124;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80125,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80125,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80125,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__80128){
var vec__80129 = p__80128;
var seq__80130 = cljs.core.seq(vec__80129);
var first__80131 = cljs.core.first(seq__80130);
var seq__80130__$1 = cljs.core.next(seq__80130);
var ___$1 = first__80131;
var values = seq__80130__$1;
