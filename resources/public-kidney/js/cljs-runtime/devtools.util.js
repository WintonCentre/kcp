...
var _STAR_print_newline_STAR__orig_val__50119_50194 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50120_50195 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50121_50196 = true;
var _STAR_print_fn_STAR__temp_val__50122_50197 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50121_50196);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50122_50197);

try{var _STAR_print_level_STAR__orig_val__50123_50198 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__50124_50199 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__50124_50199);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__50123_50198);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50120_50195);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50119_50194);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq50118){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq50118));
}));
...
var new_formatters = current_formatters.filter((function (p1__50152_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__50152_SHARP_)));
}));
...
var G__50155_50201 = f;
var target__36374__auto___50202 = G__50155_50201;
if(cljs.core.truth_(target__36374__auto___50202)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50155_50201)].join(''),"\n","target__36374__auto__"].join('')));
}

(target__36374__auto___50202["toString"] = (function (){
...
var G__50156_50203 = "%c%s";
var G__50157_50204 = "color:transparent";
var G__50158_50205 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__50156_50203,G__50157_50204,G__50158_50205) : f.call(null,G__50156_50203,G__50157_50204,G__50158_50205));
...
var args__4870__auto__ = [];
var len__4864__auto___50207 = arguments.length;
var i__4865__auto___50217 = (0);
while(true){
if((i__4865__auto___50217 < len__4864__auto___50207)){
args__4870__auto__.push((arguments[i__4865__auto___50217]));

var G__50218 = (i__4865__auto___50217 + (1));
i__4865__auto___50217 = G__50218;
continue;
} else {
}
break;
...
var vec__50170 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50170,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50170,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__50219__delegate = function (add_fmt,add_args){
...
var G__50219 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__50220__i = 0, G__50220__a = new Array(arguments.length -  1);
while (G__50220__i < G__50220__a.length) {G__50220__a[G__50220__i] = arguments[G__50220__i + 1]; ++G__50220__i;}
  add_args = new cljs.core.IndexedSeq(G__50220__a,0,null);
} 
return G__50219__delegate.call(this,add_fmt,add_args);};
G__50219.cljs$lang$maxFixedArity = 1;
G__50219.cljs$lang$applyTo = (function (arglist__50221){
var add_fmt = cljs.core.first(arglist__50221);
var add_args = cljs.core.rest(arglist__50221);
return G__50219__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq50165){
var G__50167 = cljs.core.first(seq50165);
var seq50165__$1 = cljs.core.next(seq50165);
var G__50168 = cljs.core.first(seq50165__$1);
var seq50165__$2 = cljs.core.next(seq50165__$1);
var G__50169 = cljs.core.first(seq50165__$2);
var seq50165__$3 = cljs.core.next(seq50165__$2);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50167,G__50168,G__50169,seq50165__$3);
}));
...
var seq__50178 = cljs.core.seq(features);
var chunk__50179 = null;
var count__50180 = (0);
var i__50181 = (0);
while(true){
if((i__50181 < count__50180)){
var feature = chunk__50179.cljs$core$IIndexed$_nth$arity$2(null,i__50181);
...
var G__50226 = seq__50178;
var G__50227 = chunk__50179;
var G__50228 = count__50180;
var G__50229 = (i__50181 + (1));
seq__50178 = G__50226;
chunk__50179 = G__50227;
count__50180 = G__50228;
i__50181 = G__50229;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__50178);
if(temp__5753__auto__){
var seq__50178__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__50178__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__50178__$1);
var G__50230 = cljs.core.chunk_rest(seq__50178__$1);
var G__50231 = c__4679__auto__;
var G__50232 = cljs.core.count(c__4679__auto__);
var G__50233 = (0);
seq__50178 = G__50230;
chunk__50179 = G__50231;
count__50180 = G__50232;
i__50181 = G__50233;
continue;
} else {
var feature = cljs.core.first(seq__50178__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__50234 = cljs.core.next(seq__50178__$1);
var G__50235 = null;
var G__50236 = (0);
var G__50237 = (0);
seq__50178 = G__50234;
chunk__50179 = G__50235;
count__50180 = G__50236;
i__50181 = G__50237;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o50188 = temp__5751__auto__;
return (o50188["version"]);
} else {
return null;
}
})() == null);
