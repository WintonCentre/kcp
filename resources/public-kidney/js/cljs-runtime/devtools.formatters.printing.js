...
var len__4864__auto___50498 = arguments.length;
var i__4865__auto___50499 = (0);
while(true){
if((i__4865__auto___50499 < len__4864__auto___50498)){
args__4870__auto__.push((arguments[i__4865__auto___50499]));

var G__50500 = (i__4865__auto___50499 + (1));
i__4865__auto___50499 = G__50500;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq50412){
var G__50413 = cljs.core.first(seq50412);
var seq50412__$1 = cljs.core.next(seq50412);
var G__50414 = cljs.core.first(seq50412__$1);
var seq50412__$2 = cljs.core.next(seq50412__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50413,G__50414,seq50412__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__50444_SHARP_){
return (!((cljs.core.meta(p1__50444_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50463__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e50468){var _e__36376__auto__ = e50468;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e50470){var _e__36376__auto__ = e50470;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__50473 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__50474 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__50474);

try{var map__50478 = opts;
var map__50478__$1 = cljs.core.__destructure_map(map__50478);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50478__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__50473);
}});
...
var temp__5751__auto___50564 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___50564)){
var managed_print_level_50566 = temp__5751__auto___50564;
var _STAR_print_level_STAR__orig_val__50482_50567 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__50485_50568 = managed_print_level_50566;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__50485_50568);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__50481_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__50481_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__50482_50567);
}} else {
job_fn();
}
