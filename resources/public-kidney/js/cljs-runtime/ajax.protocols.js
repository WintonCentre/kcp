...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_67221 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_67221(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_67222 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_67222(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_67223 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_67223(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_67224 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_67224(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_67227 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_67227(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_67229 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_67229(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_67230 = (function (this$,header){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_67230(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_67231 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_67231(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_67233 = (function (this$,request){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_67233(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_67234 = (function (this$,response){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_67234(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k67190,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__67196 = k67190;
var G__67196__$1 = (((G__67196 instanceof cljs.core.Keyword))?G__67196.fqn:null);
switch (G__67196__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k67190,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__67197){
var vec__67198 = p__67197;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67198,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67198,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__67189){
var self__ = this;
var G__67189__$1 = this;
return (new cljs.core.RecordIter((0),G__67189__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this67191,other67192){
var self__ = this;
var this67191__$1 = this;
return (((!((other67192 == null)))) && ((((this67191__$1.constructor === other67192.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67191__$1.status,other67192.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67191__$1.body,other67192.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67191__$1.status_text,other67192.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67191__$1.headers,other67192.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67191__$1.was_aborted,other67192.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this67191__$1.__extmap,other67192.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k67190){
var self__ = this;
var this__4509__auto____$1 = this;
var G__67209 = k67190;
var G__67209__$1 = (((G__67209 instanceof cljs.core.Keyword))?G__67209.fqn:null);
switch (G__67209__$1) {
case "status":
case "body":
case "status-text":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k67190);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__67189){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__67211 = cljs.core.keyword_identical_QMARK_;
var expr__67212 = k__4511__auto__;
if(cljs.core.truth_((pred__67211.cljs$core$IFn$_invoke$arity$2 ? pred__67211.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__67212) : pred__67211.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__67212)))){
return (new ajax.protocols.Response(G__67189,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67211.cljs$core$IFn$_invoke$arity$2 ? pred__67211.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__67212) : pred__67211.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__67212)))){
return (new ajax.protocols.Response(self__.status,G__67189,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67211.cljs$core$IFn$_invoke$arity$2 ? pred__67211.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__67212) : pred__67211.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__67212)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__67189,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67211.cljs$core$IFn$_invoke$arity$2 ? pred__67211.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__67212) : pred__67211.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__67212)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__67189,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__67211.cljs$core$IFn$_invoke$arity$2 ? pred__67211.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__67212) : pred__67211.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__67212)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__67189,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__67189),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__67189){
var self__ = this;
var this__4501__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__67189,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__67193){
var extmap__4542__auto__ = (function (){var G__67217 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__67193,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__67193)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__67217);
} else {
return G__67217;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__67193),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__67193),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__67193),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__67193),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__67193),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
