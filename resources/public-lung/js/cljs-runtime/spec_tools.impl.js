...
var vec__80011 = cljs.core.rest(expr);
var seq__80012 = cljs.core.seq(vec__80011);
var first__80013 = cljs.core.first(seq__80012);
var seq__80012__$1 = cljs.core.next(seq__80012);
var vec__80014 = first__80013;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80014,(0),null);
var form = seq__80012__$1;
...
var G__80019 = x;
var G__80019__$1 = (((G__80019 == null))?null:spec_tools.impl.polish(G__80019));
var G__80019__$2 = (((G__80019__$1 == null))?null:cljs.core.name(G__80019__$1));
if((G__80019__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__80019__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__80020 = x;
var G__80020__$1 = (((G__80020 == null))?null:cljs.core.name(G__80020));
if((G__80020__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__80020__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__80021){
var map__80022 = p__80021;
var map__80022__$1 = cljs.core.__destructure_map(map__80022);
var data = map__80022__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80022__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80022__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80022__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80022__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__80024){
var map__80025 = p__80024;
var map__80025__$1 = cljs.core.__destructure_map(map__80025);
var data = map__80025__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80025__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80025__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__80026 = data;
var G__80026__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__80026,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__80026);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__80026__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__80026__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__80031 = form;
var G__80031__$1 = (((G__80031 == null))?null:cljs.core.rest(G__80031));
if((G__80031__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__80031__$1);
}
})();
var G__80032 = m;
var G__80032__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__80032,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__80027_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__80027_SHARP_)));
})):G__80032);
var G__80032__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__80032__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__80028_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__80028_SHARP_)));
})):G__80032__$1);
var G__80032__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__80032__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__80029_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__80029_SHARP_));
})):G__80032__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__80032__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__80034 = (function (){var G__80035 = form;
var G__80035__$1 = (((G__80035 == null))?null:cljs.core.rest(G__80035));
if((G__80035__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__80035__$1);
}
})();
var map__80034__$1 = cljs.core.__destructure_map(map__80034);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80034__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80034__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80034__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80034__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__80041 = (function (){var and__4251__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__80048 = form;
var G__80048__$1 = (((G__80048 == null))?null:cljs.core.seq(G__80048));
var G__80048__$2 = (((G__80048__$1 == null))?null:cljs.core.first(G__80048__$1));
if((G__80048__$2 == null)){
return null;
} else {
var fexpr__80049 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__80049.cljs$core$IFn$_invoke$arity$1 ? fexpr__80049.cljs$core$IFn$_invoke$arity$1(G__80048__$2) : fexpr__80049.call(null,G__80048__$2));
}
})():null));
});
/**
...
var len__4864__auto___80091 = arguments.length;
var i__4865__auto___80092 = (0);
while(true){
if((i__4865__auto___80092 < len__4864__auto___80091)){
args__4870__auto__.push((arguments[i__4865__auto___80092]));

var G__80093 = (i__4865__auto___80092 + (1));
i__4865__auto___80092 = G__80093;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq80050){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq80050));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__80052){
var vec__80053 = p__80052;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80053,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80053,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__80063){
var map__80064 = p__80063;
var map__80064__$1 = cljs.core.__destructure_map(map__80064);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80064__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80064__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80064__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80064__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__80058_SHARP_){
return cljs.core.map_QMARK_(p1__80058_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__80059_SHARP_){
return cljs.core.contains_QMARK_(p1__80059_SHARP_,x);
});
}),req_keys));
