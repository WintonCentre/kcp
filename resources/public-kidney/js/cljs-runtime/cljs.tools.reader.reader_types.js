...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_51232 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_51232(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_51235 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_51235(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_51236 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_51236(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_51238 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_51238(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_51239 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_51239(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_51241 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_51241(reader);
}
});
...
var G__51259 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__51260 = s.append(c);
c = G__51259;
s = G__51260;
continue;
}
