...
return [(function (){var pred__77718 = cljs.core.instance_QMARK_;
var expr__77719 = reactive_val;
if(cljs.core.truth_((pred__77718.cljs$core$IFn$_invoke$arity$2 ? pred__77718.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__77719) : pred__77718.call(null,reagent.ratom.RAtom,expr__77719)))){
return "ra";
} else {
if(cljs.core.truth_((pred__77718.cljs$core$IFn$_invoke$arity$2 ? pred__77718.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__77719) : pred__77718.call(null,reagent.ratom.RCursor,expr__77719)))){
return "rc";
} else {
if(cljs.core.truth_((pred__77718.cljs$core$IFn$_invoke$arity$2 ? pred__77718.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__77719) : pred__77718.call(null,reagent.ratom.Reaction,expr__77719)))){
return "rx";
} else {
if(cljs.core.truth_((pred__77718.cljs$core$IFn$_invoke$arity$2 ? pred__77718.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__77719) : pred__77718.call(null,reagent.ratom.Track,expr__77719)))){
return "tr";
} else {
return "other";
}
