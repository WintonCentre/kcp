...
var G__81756 = transplants.numeric_input.num_to_str.cljs$core$IFn$_invoke$arity$2(v,dps);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__81756) : on_change.call(null,G__81756));
});
...
var G__81761 = ((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(transplants.numeric_input.str_to_num(value),transplants.numeric_input.str_to_num((value_f.cljs$core$IFn$_invoke$arity$0 ? value_f.cljs$core$IFn$_invoke$arity$0() : value_f.call(null)))))?transplants.numeric_input.num_to_str.cljs$core$IFn$_invoke$arity$2(transplants.numeric_input.validate_input(transplants.numeric_input.str_to_num(value),nmin,nmax,(0)),dps):value);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__81761) : on_change.call(null,G__81761));
} else {
return null;
}
} else {
...
transplants.numeric_input.inc_dec_button = (function transplants$numeric_input$inc_dec_button(p__81779){
var map__81780 = p__81779;
var map__81780__$1 = cljs.core.__destructure_map(map__81780);
var value_f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81780__$1,new cljs.core.Keyword(null,"value-f","value-f",-1842795108));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81780__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var _min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81780__$1,new cljs.core.Keyword(null,"_min","_min",394226897));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81780__$1,new cljs.core.Keyword(null,"max","max",61366548));
var nmin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81780__$1,new cljs.core.Keyword(null,"nmin","nmin",1751665282));
var nmax = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81780__$1,new cljs.core.Keyword(null,"nmax","nmax",608994404));
var dps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81780__$1,new cljs.core.Keyword(null,"dps","dps",1756250620));
var increment = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81780__$1,new cljs.core.Keyword(null,"increment","increment",-1558831484));
...
transplants.numeric_input.numeric_input = (function transplants$numeric_input$numeric_input(p__81802){
var map__81803 = p__81802;
var map__81803__$1 = cljs.core.__destructure_map(map__81803);
var props = map__81803__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81803__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var _id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81803__$1,new cljs.core.Keyword(null,"_id","_id",-789960287));
var value_f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81803__$1,new cljs.core.Keyword(null,"value-f","value-f",-1842795108));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81803__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var min = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81803__$1,new cljs.core.Keyword(null,"min","min",444991522));
var max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81803__$1,new cljs.core.Keyword(null,"max","max",61366548));
var dps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81803__$1,new cljs.core.Keyword(null,"dps","dps",1756250620));
var units = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81803__$1,new cljs.core.Keyword(null,"units","units",-533089095));
var vec__81806 = clojure.string.split.cljs$core$IFn$_invoke$arity$2((value_f.cljs$core$IFn$_invoke$arity$0 ? value_f.cljs$core$IFn$_invoke$arity$0() : value_f.call(null)),/:/);
var good = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81806,(0),null);
var bad = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81806,(1),null);
...
var key_code = p1__81800_SHARP_.nativeEvent.code;
if(cljs.core.truth_((function (){var fexpr__81821 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["ArrowUp",null,"ArrowDown",null], null), null);
return (fexpr__81821.cljs$core$IFn$_invoke$arity$1 ? fexpr__81821.cljs$core$IFn$_invoke$arity$1(key_code) : fexpr__81821.call(null,key_code));
})())){
p1__81800_SHARP_.preventDefault();
} else {
}
