...
var i_53562 = (0);
while(true){
if((i_53562 < arr.length)){
(arr[i_53562] = null);

var G__53565 = (i_53562 + (1));
i_53562 = G__53565;
continue;
} else {
}
...
var i_53575 = (self__.level + (1));
while(true){
if((i_53575 <= (new_level + (1)))){
(update[i_53575] = self__.header);

var G__53576 = (i_53575 + (1));
i_53575 = G__53576;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_53577 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_53577[i]));
} else {
x__$2.forward.push((((i < links_53577.length))?(links_53577[i]):null));
}

if((i < links_53577.length)){
(links_53577[i] = x__$2);
} else {
links_53577.push(x__$2);
}
...
var i_53581 = (0);
while(true){
if((i_53581 <= self__.level)){
var links_53582 = (update[i_53581]).forward;
if((x__$1 === (((i_53581 < links_53582.length))?(links_53582[i_53581]):null))){
(links_53582[i_53581] = (x__$1.forward[i_53581]));

var G__53583 = (i_53581 + (1));
i_53581 = G__53583;
continue;
} else {
var G__53584 = (i_53581 + (1));
i_53581 = G__53584;
continue;
}
} else {
...
var G__53586 = nx;
var G__53587 = (level__$1 - (1));
x = G__53586;
level__$1 = G__53587;
continue;
} else {
var G__53588 = x;
var G__53589 = (level__$1 - (1));
x = G__53588;
level__$1 = G__53589;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__53592 = nx;
var G__53593 = (level__$1 - (1));
x = G__53592;
level__$1 = G__53593;
continue;
} else {
var G__53594 = x;
var G__53595 = (level__$1 - (1));
x = G__53594;
level__$1 = G__53595;
continue;
}
