...
var garden$compiler$IExpandable$expand$dyn_82495 = (function (this$){
...
return garden$compiler$IExpandable$expand$dyn_82495(this$);
}
});
...
var prefix = (function (p1__82338_SHARP_,p2__82339_SHARP_){
return garden.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__82338_SHARP_,"-",p2__82339_SHARP_], 0));
});
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__82340){
var vec__82341 = p__82340;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82341,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82341,(1),null);
if(garden.util.hash_map_QMARK_(v)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m1,p__82344){
var vec__82345 = p__82344;
var k1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82345,(0),null);
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82345,(1),null);
...
var vec__82348 = cljs.core.split_with(garden.selectors.selector_QMARK_,rule);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82348,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82348,(1),null);
...
var vec__82351 = garden.compiler.divide_vec(garden.util.declaration_QMARK_,children__$1);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82351,(0),null);
var xs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82351,(1),null);
var ys = (function (){var _STAR_selector_context_STAR__orig_val__82354 = garden.compiler._STAR_selector_context_STAR_;
var _STAR_selector_context_STAR__temp_val__82355 = ((cljs.core.seq(selector__$1))?selector__$1:garden.compiler._STAR_selector_context_STAR_);
(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__temp_val__82355);
...
}finally {(garden.compiler._STAR_selector_context_STAR_ = _STAR_selector_context_STAR__orig_val__82354);
}})();
...
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__82356 = cljs.core.get_global_hierarchy;
return (fexpr__82356.cljs$core$IFn$_invoke$arity$0 ? fexpr__82356.cljs$core$IFn$_invoke$arity$0() : fexpr__82356.call(null));
})());
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__82357){
...
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82359__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82359__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
var temp__5751__auto__ = (function (){var G__82360 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(garden.compiler._STAR_flags_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"media-expressions","media-expressions",1920421643),new cljs.core.Keyword(null,"nesting-behavior","nesting-behavior",-1555995755)], null));
return (garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1 ? garden.compiler.media_expression_behavior.cljs$core$IFn$_invoke$arity$1(G__82360) : garden.compiler.media_expression_behavior.call(null,G__82360));
})();
if(cljs.core.truth_(temp__5751__auto__)){
...
garden.compiler.expand_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__82361){
var map__82362 = p__82361;
var map__82362__$1 = cljs.core.__destructure_map(map__82362);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82362__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__82363 = value;
var map__82363__$1 = cljs.core.__destructure_map(map__82363);
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82363__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82363__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var media_queries__$1 = garden.compiler.expand_media_query_expression(media_queries);
var xs = (function (){var _STAR_media_query_context_STAR__orig_val__82367 = garden.compiler._STAR_media_query_context_STAR_;
var _STAR_media_query_context_STAR__temp_val__82368 = media_queries__$1;
(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__temp_val__82368);
...
}finally {(garden.compiler._STAR_media_query_context_STAR_ = _STAR_media_query_context_STAR__orig_val__82367);
}})();
var vec__82364 = garden.compiler.divide_vec(garden.util.at_media_QMARK_,xs);
var subqueries = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82364,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82364,(1),null);
...
var garden$compiler$CSSRenderer$render_css$dyn_82503 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return garden$compiler$CSSRenderer$render_css$dyn_82503(this$);
}
});
...
var ys = (function (){var iter__4652__auto__ = (function garden$compiler$iter__82394(s__82395){
return (new cljs.core.LazySeq(null,(function (){
var s__82395__$1 = s__82395;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__82395__$1);
if(temp__5753__auto__){
var s__82395__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__82395__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__82395__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__82397 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__82396 = (0);
while(true){
if((i__82396 < size__4651__auto__)){
var x = cljs.core._nth(c__4650__auto__,i__82396);
cljs.core.chunk_append(b__82397,((cljs.core.sequential_QMARK_(x))?garden.compiler.space_separated_list.cljs$core$IFn$_invoke$arity$2(f,x):(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x))));

var G__82506 = (i__82396 + (1));
i__82396 = G__82506;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__82397),garden$compiler$iter__82394(cljs.core.chunk_rest(s__82395__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__82397),null);
}
} else {
var x = cljs.core.first(s__82395__$2);
return cljs.core.cons(((cljs.core.sequential_QMARK_(x))?garden.compiler.space_separated_list.cljs$core$IFn$_invoke$arity$2(f,x):(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x))),garden$compiler$iter__82394(cljs.core.rest(s__82395__$2)));
}
} else {
return null;
}
...
garden.compiler.render_property_and_value = (function garden$compiler$render_property_and_value(p__82404){
var vec__82405 = p__82404;
var prop = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82405,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82405,(1),null);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__82408_SHARP_){
return cljs.core.cons(p1__82408_SHARP_,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p1__82408_SHARP_) : f.call(null,p1__82408_SHARP_)));
 ...
 */
garden.compiler.prefixed_blocks = (function garden$compiler$prefixed_blocks(vendors,p__82409){
var vec__82410 = p__82409;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82410,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82410,(1),null);
var iter__4652__auto__ = (function garden$compiler$prefixed_blocks_$_iter__82413(s__82414){
return (new cljs.core.LazySeq(null,(function (){
var s__82414__$1 = s__82414;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__82414__$1);
if(temp__5753__auto__){
var s__82414__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__82414__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__82414__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__82416 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__82415 = (0);
while(true){
if((i__82415 < size__4651__auto__)){
var vendor = cljs.core._nth(c__4650__auto__,i__82415);
cljs.core.chunk_append(b__82416,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.util.vendor_prefix(vendor,cljs.core.name(p)),v], null));

var G__82507 = (i__82415 + (1));
i__82415 = G__82507;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__82416),garden$compiler$prefixed_blocks_$_iter__82413(cljs.core.chunk_rest(s__82414__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__82416),null);
}
} else {
var vendor = cljs.core.first(s__82414__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [garden.util.vendor_prefix(vendor,cljs.core.name(p)),v], null),garden$compiler$prefixed_blocks_$_iter__82413(cljs.core.rest(s__82414__$2)));
}
} else {
return null;
}
...
var vec__82417 = block;
var p = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82417,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82417,(1),null);
 ...
 *   fully expanded.
 */
garden.compiler.render_rule = (function garden$compiler$render_rule(p__82420){
var vec__82421 = p__82420;
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82421,(0),null);
var declarations = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82421,(1),null);
var rule = vec__82421;
 ...
 */
garden.compiler.render_media_expr_part = (function garden$compiler$render_media_expr_part(p__82424){
var vec__82425 = p__82424;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82425,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82425,(1),null);
var vec__82428 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.compiler.render_value,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));
var sk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82428,(0),null);
var sv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82428,(1),null);
if(v === true){
return sk;
} else {
if(v === false){
...
var map__82431 = css_unit;
var map__82431__$1 = cljs.core.__destructure_map(map__82431);
var magnitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82431__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var unit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82431__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var map__82432 = css_function;
var map__82432__$1 = cljs.core.__destructure_map(map__82432);
var function$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82432__$1,new cljs.core.Keyword(null,"function","function",-2127255473));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82432__$1,new cljs.core.Keyword(null,"args","args",1315556576));
...
var map__82433 = garden.color.as_hsl(c);
var map__82433__$1 = cljs.core.__destructure_map(map__82433);
var hue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82433__$1,new cljs.core.Keyword(null,"hue","hue",-508078848));
var saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82433__$1,new cljs.core.Keyword(null,"saturation","saturation",-14247929));
var lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82433__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930));
var vec__82434 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(garden.units.percent,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [saturation,lightness], null));
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82434,(0),null);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82434,(1),null);
...
var method_cache__4749__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4750__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__82437 = cljs.core.get_global_hierarchy;
return (fexpr__82437.cljs$core$IFn$_invoke$arity$0 ? fexpr__82437.cljs$core$IFn$_invoke$arity$0() : fexpr__82437.call(null));
})());
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"import","import",-1399500709),(function (p__82440){
var map__82441 = p__82440;
var map__82441__$1 = cljs.core.__destructure_map(map__82441);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82441__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__82442 = value;
var map__82442__$1 = cljs.core.__destructure_map(map__82442);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82442__$1,new cljs.core.Keyword(null,"url","url",276297046));
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82442__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
...
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"keyframes","keyframes",-1437976012),(function (p__82444){
var map__82445 = p__82444;
var map__82445__$1 = cljs.core.__destructure_map(map__82445);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82445__$1,new cljs.core.Keyword(null,"value","value",305978217));
var map__82446 = value;
var map__82446__$1 = cljs.core.__destructure_map(map__82446);
var identifier = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82446__$1,new cljs.core.Keyword(null,"identifier","identifier",-805503498));
var frames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82446__$1,new cljs.core.Keyword(null,"frames","frames",1765687497));
...
return garden.compiler.rule_join(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__82443_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__82443_SHARP_),body].join('');
}),cljs.core.cons("@keyframes ",cljs.core.map.cljs$core$IFn$_invoke$arity$2(prefix,garden.compiler.vendors()))));
} else {
return null;
}
}));
garden.compiler.render_at_rule.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"media","media",-1066138403),(function (p__82447){
...
var media_queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82449__$1,new cljs.core.Keyword(null,"media-queries","media-queries",-1563277678));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82449__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
...
var _STAR_flags_STAR__orig_val__82481 = garden.compiler._STAR_flags_STAR_;
var _STAR_flags_STAR__temp_val__82482 = flags;
(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__temp_val__82482);
...
}finally {(garden.compiler._STAR_flags_STAR_ = _STAR_flags_STAR__orig_val__82481);
}});
/**
 * Prefix stylesheet with files in preamble. Not available in
 *   ClojureScript.
 */
garden.compiler.do_preamble = (function garden$compiler$do_preamble(p__82483,stylesheet){
var map__82484 = p__82483;
var map__82484__$1 = cljs.core.__destructure_map(map__82484);
var preamble = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82484__$1,new cljs.core.Keyword(null,"preamble","preamble",1641040241));
return stylesheet;
});
/**
 * Compress CSS if the pretty-print(?) flag is true.
 */
garden.compiler.do_compression = (function garden$compiler$do_compression(p__82485,stylesheet){
var map__82486 = p__82485;
var map__82486__$1 = cljs.core.__destructure_map(map__82486);
var pretty_print_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82486__$1,new cljs.core.Keyword(null,"pretty-print?","pretty-print?",1932217158));
var pretty_print = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82486__$1,new cljs.core.Keyword(null,"pretty-print","pretty-print",-1314067013));
 ...
 */
garden.compiler.do_output_to = (function garden$compiler$do_output_to(p__82487,stylesheet){
var map__82488 = p__82487;
var map__82488__$1 = cljs.core.__destructure_map(map__82488);
var output_to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82488__$1,new cljs.core.Keyword(null,"output-to","output-to",-965533968));
return stylesheet;
});
/**
...
var len__4864__auto___82509 = arguments.length;
var i__4865__auto___82510 = (0);
while(true){
if((i__4865__auto___82510 < len__4864__auto___82509)){
args__4870__auto__.push((arguments[i__4865__auto___82510]));

var G__82511 = (i__4865__auto___82510 + (1));
i__4865__auto___82510 = G__82511;
continue;
} else {
}
break;
...
var vec__82491 = (cljs.core.truth_((function (){var and__4251__auto__ = garden.util.hash_map_QMARK_(flags);
...
var flags__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82491,(0),null);
var rules__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82491,(1),null);
...
/** @this {Function} */
(garden.compiler.compile_css.cljs$lang$applyTo = (function (seq82489){
var G__82490 = cljs.core.first(seq82489);
var seq82489__$1 = cljs.core.next(seq82489);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__82490,seq82489__$1);
}));
