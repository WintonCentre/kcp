      ...
      (let [index (atom 0)
        ...
        [ui/page "goodnight"
         [:div
          ...
          #_(let [path (paths/organ-centre-name-tool "kidney" "UK" "ldsurvival")]
    ...
    (let [day @(rf/subscribe [::subs/test-day])
      ...
      [ui/page "hey"
       [:div
        ...
        (let [coll-score-zero-and-one    @(rf/subscribe [::subs/my-collection-score-zero-and-one])
          ...
          (doseq [each coll-score-zero-and-one]
            (if (and
              ...
              (swap! wrong-labels-all-scors :assoc {:one :year-one} (:set-of-inputs each)))
        ...
        [:div
         [:p (str @(rf/subscribe [::subs/wrong-label-all-scors]))]
         ]
