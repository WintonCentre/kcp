...
var len__4864__auto___50325 = arguments.length;
var i__4865__auto___50326 = (0);
while(true){
if((i__4865__auto___50326 < len__4864__auto___50325)){
args__4870__auto__.push((arguments[i__4865__auto___50326]));

var G__50327 = (i__4865__auto___50326 + (1));
i__4865__auto___50326 = G__50327;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq50315){
var G__50316 = cljs.core.first(seq50315);
var seq50315__$1 = cljs.core.next(seq50315);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50316,seq50315__$1);
}));
...
return cljs.core.some((function (p1__50318_SHARP_){
return (p1__50318_SHARP_ === object);
}),history);
});
